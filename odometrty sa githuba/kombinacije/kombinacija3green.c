...
void kombinacija3green(void)
{
	...
	switch(step1)
	{
		...
		if(flag1 == 0)
		{
			...
			stigao_flag = 0;
			flag1 = 1;
			zadaj_X_Y_teta( -1000, 800, -180, Nazad); // 1520
		}
		else if((stigao_flag == 1) && (brojac >= VremeCekanjaPIDa))
		{
			brojac = 0;
		...
		if(flag1 == 0)
		{
			...
			flag1 = 1;
			otvori_hvataljku();
			zadaj_X_Y_teta( -1225, 715, 90, Napred); // 1520
		}
		else if((stigao_flag == 1) && (brojac >= VremeCekanjaPIDa))
		{
			brojac = 0;
		...
		if(flag1 == 0)
		{
			...
			stigao_flag = 0;
			flag1 = 1;
			zadaj_X_Y_teta( -1150, 700, 90, Napred);
		}
		else if((stigao_flag == 1) && (brojac >= VremeCekanjaPIDa))
		{
			brojac = 0;
		...
		if(flag1 == 0)
		{
			...
			stigao_flag = 0;
			flag1 = 1;
			zadaj_X_Y_teta( -175, 120, 90, Napred);
		}
		else if((stigao_flag == 1) && (brojac >= VremeCekanjaPIDa))
		{
			brojac = 0;
		...
		if(flag1 == 0)
		{
			...
			stigao_flag = 0;
			flag1 = 1;
			zadaj_X_Y_teta( -175, 120, 180, Napred);
		}
		else if((stigao_flag == 1) && (brojac >= VremeCekanjaPIDa))
		{
			zeljena_pravolinijska_brzina = treca_brzina;
