...
//racunanje
//enkoder daj 2500 inkremenata po puno krugu,mnozi se sa cetiri

#define PI 3.1415926535897932384626433832795
#define d_tocka 79
#define Distanca_tockova 284
#define inc_u_mm (10000.0f / (d_tocka*PI))
#define inc_u_360 (20000.0f * Distanca_tockova / d_tocka)

void Podesi_Parametre_Robota(void)
{
	//mehanicke karakteristike
	metar = inc_u_mm*1000 + 25600; //75000(pre pelesa za 1 m); kopirano od pelesa
								//-15550
	krug360 = inc_u_360-13300; //(PRE PELESA: 49650 - eksperiment 1;  //66250 - matematika;	//broj inkremenata za jedan krug - eksperiment!)koriguj 50 solo
	...
	zeljena_pravolinijska_brzina = 140;		//brzina kojom se pravo krece robot //bilo 300 // pa 400
	zeljena_brzina_okretanja = 90; //brzina kojom se okrece robot //bilo deljeno
...
void Podesi_PID_Pojacanja(void)
{
	...
	Kp_pravolinijski = 10; //40
	Ki_pravolinijski = 0;
	Kd_pravolinijski = 1; //2 //15
	Kp_teta_pravolinijski = 8; //8 //50 //150
		
	//Regulacija ugaonog zakretanja
	Kp_teta = 4.3; //4.3 // 8 //15
	Ki_teta = 0;
	Kd_teta = 5; //5 //15
	//Kp_teta_okretanje = 6;
...
void Podesi_USART_Komunikaciju(void)
{
	...
	USART_Baudrate_Set(&USARTE0, 103, -2 );
	//Ukljucivanje RX i TX
